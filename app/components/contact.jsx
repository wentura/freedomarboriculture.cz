  ...
  return (
    <section className="text-tmava body-font relative mt-24" id="kontakt">
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="h-96 w-96 bg-gray-300 rounded-full overflow-hidden sm:mr-10 mt-8 flex items-end justify-start relative mx-auto"></div>
          ...
          <ul className="relative mb-4">
            <li className="text-md md:text-lg lg:text-3xl mb-1 font-extrabold title-font">
              <h4>
                ...
                <span className="text-zelena">Markéta</span>{" "}
                <span className="text-cervena">Svobodová</span>
              </h4>
            </li>
            ...
            <li className="md:text-lg my-2 py-2">datová schránka: ciwq7b9 </li>
